...
def map_audit_event(payload: dict[str, Any]) -> ConsoleEvent | None:
    ...
    mapping: dict[str, tuple[str, str]] = {
        ...
        "whole_plan_review_started": ("review:start", "whole-plan review loop started"),
        "whole_plan_scope_review_started": ("review:stage", "scope review started"),
        "whole_plan_scope_review_changes_requested": (
            "review",
            "scope review changes requested",
        ),
        "whole_plan_review_approved": ("review", "whole plan review approved"),
        "whole_plan_review_failed": ("error", "whole plan review failed"),
        "whole_output_review_started": ("review:start", "whole-output review loop started"),
        ...
        "review_revision_required": ("review", "review revision required"),
        "review_incomplete": ("warning", "review incomplete"),
        "review_advisory_handoff_started": ("review", "review advisory handoff started"),
        ...
        "resume_config_drift": ("run:resume", "resume config drift"),
