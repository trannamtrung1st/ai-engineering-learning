...
from top_down_planning.config_loader import merge_run_options, options_to_planning_limits, options_to_render_config
...
def _execute_run(
    *,
    ...
    max_depth: int | None,
    max_children_per_expansion: int | None,
...
def main_callback(
    ...
    max_depth: Optional[int] = typer.Option(
        ...
        "--max-depth",
        min=1,
        help="Maximum plan item depth (root is 0)",
    ),
    max_children_per_expansion: Optional[int] = typer.Option(
        None,
        "--max-children-per-expansion",
        min=1,
        help="Maximum direct children per expand operation",
    ),
