...
tdp resume --run <run-id> --config tools/top_down_planning/examples/top-down-planning.yaml
tdp sub-tdp attach --parent <parent-run-id> --unit <plan-item-id> --child <child-run-id> --config <parent-config.yaml>
```
