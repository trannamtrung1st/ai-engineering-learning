...
- Keep transitions snappy and intentional — {{DESIGN_STYLE_NAME}} favors bold, immediate state changes over slow easing.
...
- Depth is created through {{SHADOW_STYLE}} shadows and thick borders, not transparency or blur.
