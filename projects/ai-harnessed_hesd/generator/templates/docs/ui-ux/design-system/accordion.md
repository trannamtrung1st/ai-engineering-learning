...
- **Wrapper:** full width, 2px border (border-default color), {{RADIUS_DEFAULT}} radius — clips first/last item corners
...
### Separated Cards
Each item is independent — has its own 2px border, {{RADIUS_DEFAULT}} radius, and shadow-sm. 8px bottom margin between items. No shared outer border.
