...
- **Heading font:** {{HEADING_FONT}}, sans-serif — configured at app level via `--font-head`, never override
- **Body font:** {{BODY_FONT}}, sans-serif — configured at app level via `--font-sans`, never override
- **Headings:** bold weight (700–900), heading text color, {{HEADING_FONT}}
- **Body copy:** {{BODY_FONT}}, body text color, never use brand color for paragraphs longer than one sentence
