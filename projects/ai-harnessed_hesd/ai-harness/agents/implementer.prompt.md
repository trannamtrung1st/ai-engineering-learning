...
| 16 | Navigation surface + home link | Authenticated page missing persistent nav, home link, or **clickable Attendly logo** linking to role home |
| 17 | Login page neutrality | Login heading/copy contains role name; post-login lands on wrong page |
| 18 | Back-to-home / logo shortcut | Any page has no clickable path back to home — Attendly logo in nav must navigate to role home; breadcrumb first segment or explicit home item also acceptable |
